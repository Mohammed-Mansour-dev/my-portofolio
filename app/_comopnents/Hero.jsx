  ...
  return (
    <section className="flex h-screen relative overflow-hidden flex-col md:flex-row">
      ...
      <div className="w-full bg-[#8e9294]  md:w-1/2 md:h-full relative">
        <div ref={imageCoverRef} className="bg-[#040f16] absolute left-0 right-0 z-10 h-full transition-all duration-1000 bottom-0 w-full "></div>
      ...
      <div className="w-full h-1/2 md:w-1/2 md:h-full bg-[#040f16] flex justify-center items-center relative overflow-hidden ">
        <div className=" w-full h-full ">
          <div ref={cardRef} className=" text-2xl bg-[#54625a]/90 mt-32 w-fit ml-auto rounded-tl-2xl rounded-bl-2xl pl-7 py-3 pr-14 ">
            <h1 className='flex flex-col' >
              <span className='flex wordsp items-center' >Fullstack
                <svg className='ml-2' width="40px" height="40px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className='md:max-w-96 md:ml-20   mt-24' >
            <h1 className='text-5xl  split font-bold' >Hello ,I am Mohammed</h1>
            <p className='my-5 text-lg desc  text-gray-400 ' >Full Stack Developer passionate about crafting clean, functional, and user-friendly web applications, and intuitive digital experiences.</p>
          </div>
        </div>
      </div>
      <TextAnimation />
